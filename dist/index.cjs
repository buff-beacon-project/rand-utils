...
var BitReader = class _BitReader {
   ...
   */
  stream() {
    return new (0, _bitbuffer.BitStream)(this.buffer);
  }
  /**
   ...
   */
  view() {
    return new (0, _bitbuffer.BitView)(this.buffer);
  }
  /**
...
exports.BitReader = BitReader; exports.boundedRandom = boundedRandom; exports.getShuffleSeed = getShuffleSeed; exports.shuffle = shuffle; exports.shuffleSelf = shuffleSelf; exports.unfoldBitstream = unfoldBitstream;
